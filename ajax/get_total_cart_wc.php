...
function get_woocommerce_cart_total($cart_key) {
    global $woocommerce_cocart_url_api, $woocommerce_store_url;
    $cart_total = "--";
    $item_count = 0;
    $items = array();
    ...
    $url_cart = "$woocommerce_store_url/cart/?cocart-load-cart=$cart_key";
    $url_checkout = "$woocommerce_store_url/checkout/?cocart-load-cart=$cart_key";
